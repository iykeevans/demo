...
function blogCrop(){
if ($(window).width() > 979) {
$('.extension-px_blog-home .image').each(function() {	   
var that = $(this);
...
$('#testimonial-carousel').owlCarousel({
    items:1,
	navigation: true,
	navigationText: ['<span class="left"><a class="fa prev">&nbsp;</a></span>', '<span class="right"><a class="fa next">&nbsp;</a></span>'],
	pagination: false,
	singleItem:true,
	autoPlay:false,
	itemsDesktop : [1000,1],
...
$(window).resize(function() {
 ...
 $(document).ready(function(){
$('#cms-main-img-carousel').owlCarousel({
    items:3,
	navigation: false,
	pagination: true,
	singleItem:true,
  ...
  $(document).ready(function(){
$('#category-img-carousel').owlCarousel({
    items:3,
	navigation: false,
	pagination: true,
	singleItem:true,
